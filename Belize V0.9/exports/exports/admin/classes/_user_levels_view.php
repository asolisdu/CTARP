 ...
 * Page class
 */
class _user_levels_view extends _user_levels
{
	...
	// Page object name
	public $PageObjName = "_user_levels_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "_user_levelslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "_user_levelslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "_user_levelslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
