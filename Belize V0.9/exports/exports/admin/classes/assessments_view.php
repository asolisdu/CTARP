 ...
 * Page class
 */
class assessments_view extends assessments
{
	...
	// Page object name
	public $PageObjName = "assessments_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "assessmentslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "assessmentslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "assessmentslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupOtherOptions()
	{
		...
		// "detail_results"
		$item = &$option->add("detail_results");
		$body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("results", "TblCaption");
		...
		if ($GLOBALS["results_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'assessments')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=results")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailViewLink")) . "</a></li>";
			if ($detailViewTblVar != "")
				$detailViewTblVar .= ",";
		...
		if ($GLOBALS["results_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'assessments')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=results")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailEditLink")) . "</a></li>";
			if ($detailEditTblVar != "")
				$detailEditTblVar .= ",";
			$detailEditTblVar .= "results";
		}
		if ($GLOBALS["results_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'assessments')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode($this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=results")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailCopyLink")) . "</a></li>";
			if ($detailCopyTblVar != "")
				$detailCopyTblVar .= ",";
		...
		$item->Body = $body;
		$item->Visible = $Security->allowList(CurrentProjectID() . 'results');
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		// "detail_answers"
		$item = &$option->add("detail_answers");
		$body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("answers", "TblCaption");
		...
		if ($GLOBALS["answers_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'assessments')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=answers")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailViewLink")) . "</a></li>";
			if ($detailViewTblVar != "")
				$detailViewTblVar .= ",";
		...
		if ($GLOBALS["answers_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'assessments')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=answers")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailEditLink")) . "</a></li>";
			if ($detailEditTblVar != "")
				$detailEditTblVar .= ",";
			$detailEditTblVar .= "answers";
		}
		if ($GLOBALS["answers_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'assessments')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode($this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=answers")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailCopyLink")) . "</a></li>";
			if ($detailCopyTblVar != "")
				$detailCopyTblVar .= ",";
		...
		$body = "<div class=\"btn-group btn-group-sm ew-btn-group\">" . $body . "</div>";
		$item->Body = $body;
		$item->Visible = $Security->allowList(CurrentProjectID() . 'answers');
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("results", $detailTblVar)) {
				if (!isset($GLOBALS["results_grid"]))
					$GLOBALS["results_grid"] = new results_grid();
				if ($GLOBALS["results_grid"]->DetailView) {
					$GLOBALS["results_grid"]->CurrentMode = "view";
			...
			if (in_array("answers", $detailTblVar)) {
				if (!isset($GLOBALS["answers_grid"]))
					$GLOBALS["answers_grid"] = new answers_grid();
				if ($GLOBALS["answers_grid"]->DetailView) {
					$GLOBALS["answers_grid"]->CurrentMode = "view";
