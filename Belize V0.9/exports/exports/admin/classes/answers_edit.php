 ...
 * Page class
 */
class answers_edit extends answers
{
	...
	// Page object name
	public $PageObjName = "answers_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// recommendations
			$this->recommendations->setDbValueDef($rsnew, $this->recommendations->CurrentValue, NULL, $this->recommendations->ReadOnly);
