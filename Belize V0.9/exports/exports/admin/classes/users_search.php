...
class users_search extends users
{
	...
	// Page object name
	public $PageObjName = "users_search";
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->first_names); // first_names
		$this->buildSearchUrl($srchUrl, $this->last_names); // last_names
	...
	protected function loadSearchValues()
	{
		...
		if ($this->id->AdvancedSearch->post())
			$got = TRUE;
		if ($this->first_names->AdvancedSearch->post())
			$got = TRUE;
		if ($this->last_names->AdvancedSearch->post())
			$got = TRUE;
