 ...
 * Page class
 */
class results_view extends results
{
	...
	// Page object name
	public $PageObjName = "results_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "resultslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "resultslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "resultslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
