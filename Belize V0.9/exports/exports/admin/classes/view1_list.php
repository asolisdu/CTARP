 ...
 * Page class
 */
class view1_list extends view1
{
	...
	public function __construct()
	{
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fview1listsrch";
	...
	protected function hideFieldsForAddEdit()
	{
		if ($this->isAdd() || $this->isCopy() || $this->isGridAdd())
			$this->loan_section_id->Visible = FALSE;
		if ($this->isAdd() || $this->isCopy() || $this->isGridAdd())
			$this->user_id->Visible = FALSE;
		if ($this->isAdd() || $this->isCopy() || $this->isGridAdd())
			$this->loan_purpose_id->Visible = FALSE;
		if ($this->isAdd() || $this->isCopy() || $this->isGridAdd())
			$this->assessment_id->Visible = FALSE;
	}
	...
	public function run()
	{
		...
		$this->loan_section_id->setVisibility();
		$this->loan_section_name->setVisibility();
		$this->user_id->setVisibility();
		$this->_email->setVisibility();
		$this->loan_purpose_id->setVisibility();
		$this->loan_purpose_name->setVisibility();
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 4) {
			$this->loan_section_id->setOldValue($arKeyFlds[0]);
			if (!is_numeric($this->loan_section_id->OldValue))
				return FALSE;
			$this->user_id->setOldValue($arKeyFlds[1]);
			if (!is_numeric($this->user_id->OldValue))
				return FALSE;
			$this->loan_purpose_id->setOldValue($arKeyFlds[2]);
			if (!is_numeric($this->loan_purpose_id->OldValue))
				return FALSE;
			$this->assessment_id->setOldValue($arKeyFlds[3]);
			if (!is_numeric($this->assessment_id->OldValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	public function getFilterList()
	{
		...
		$filterList = "";
		$savedFilterList = "";
		$filterList = Concat($filterList, $this->loan_section_id->AdvancedSearch->toJson(), ","); // Field loan_section_id
		$filterList = Concat($filterList, $this->loan_section_name->AdvancedSearch->toJson(), ","); // Field loan_section_name
		...
		$filterList = Concat($filterList, $this->loan_purpose_name->AdvancedSearch->toJson(), ","); // Field loan_purpose_name
		...
		$filterList = Concat($filterList, $this->total_score->AdvancedSearch->toJson(), ","); // Field total_score
		$filterList = Concat($filterList, $this->status->AdvancedSearch->toJson(), ","); // Field status
		$filterList = Concat($filterList, $this->customer_first_name->AdvancedSearch->toJson(), ","); // Field customer_first_name
		$filterList = Concat($filterList, $this->customer_last_name->AdvancedSearch->toJson(), ","); // Field customer_last_name
		$filterList = Concat($filterList, $this->customer_age->AdvancedSearch->toJson(), ","); // Field customer_age
		...
		$filterList = Concat($filterList, $this->lat->AdvancedSearch->toJson(), ","); // Field lat
		$filterList = Concat($filterList, $this->lon->AdvancedSearch->toJson(), ","); // Field lon
	...
	protected function restoreFilterList()
	{
		...
		// Field loan_section_id
		$this->loan_section_id->AdvancedSearch->SearchValue = @$filter["x_loan_section_id"];
		$this->loan_section_id->AdvancedSearch->SearchOperator = @$filter["z_loan_section_id"];
		$this->loan_section_id->AdvancedSearch->SearchCondition = @$filter["v_loan_section_id"];
		$this->loan_section_id->AdvancedSearch->SearchValue2 = @$filter["y_loan_section_id"];
		$this->loan_section_id->AdvancedSearch->SearchOperator2 = @$filter["w_loan_section_id"];
		$this->loan_section_id->AdvancedSearch->save();

		// Field loan_section_name
		$this->loan_section_name->AdvancedSearch->SearchValue = @$filter["x_loan_section_name"];
		$this->loan_section_name->AdvancedSearch->SearchOperator = @$filter["z_loan_section_name"];
		$this->loan_section_name->AdvancedSearch->SearchCondition = @$filter["v_loan_section_name"];
		$this->loan_section_name->AdvancedSearch->SearchValue2 = @$filter["y_loan_section_name"];
		$this->loan_section_name->AdvancedSearch->SearchOperator2 = @$filter["w_loan_section_name"];
		$this->loan_section_name->AdvancedSearch->save();
		...
		// Field loan_purpose_name
		$this->loan_purpose_name->AdvancedSearch->SearchValue = @$filter["x_loan_purpose_name"];
		$this->loan_purpose_name->AdvancedSearch->SearchOperator = @$filter["z_loan_purpose_name"];
		$this->loan_purpose_name->AdvancedSearch->SearchCondition = @$filter["v_loan_purpose_name"];
		$this->loan_purpose_name->AdvancedSearch->SearchValue2 = @$filter["y_loan_purpose_name"];
		$this->loan_purpose_name->AdvancedSearch->SearchOperator2 = @$filter["w_loan_purpose_name"];
		$this->loan_purpose_name->AdvancedSearch->save();
		...
		// Field total_score
		$this->total_score->AdvancedSearch->SearchValue = @$filter["x_total_score"];
		$this->total_score->AdvancedSearch->SearchOperator = @$filter["z_total_score"];
		$this->total_score->AdvancedSearch->SearchCondition = @$filter["v_total_score"];
		$this->total_score->AdvancedSearch->SearchValue2 = @$filter["y_total_score"];
		$this->total_score->AdvancedSearch->SearchOperator2 = @$filter["w_total_score"];
		$this->total_score->AdvancedSearch->save();
		...
		$this->customer_first_name->AdvancedSearch->SearchValue = @$filter["x_customer_first_name"];
		$this->customer_first_name->AdvancedSearch->SearchOperator = @$filter["z_customer_first_name"];
		$this->customer_first_name->AdvancedSearch->SearchCondition = @$filter["v_customer_first_name"];
		$this->customer_first_name->AdvancedSearch->SearchValue2 = @$filter["y_customer_first_name"];
		$this->customer_first_name->AdvancedSearch->SearchOperator2 = @$filter["w_customer_first_name"];
		$this->customer_first_name->AdvancedSearch->save();

		// Field customer_last_name
		$this->customer_last_name->AdvancedSearch->SearchValue = @$filter["x_customer_last_name"];
		$this->customer_last_name->AdvancedSearch->SearchOperator = @$filter["z_customer_last_name"];
		$this->customer_last_name->AdvancedSearch->SearchCondition = @$filter["v_customer_last_name"];
		$this->customer_last_name->AdvancedSearch->SearchValue2 = @$filter["y_customer_last_name"];
		$this->customer_last_name->AdvancedSearch->SearchOperator2 = @$filter["w_customer_last_name"];
		$this->customer_last_name->AdvancedSearch->save();

		// Field customer_age
		$this->customer_age->AdvancedSearch->SearchValue = @$filter["x_customer_age"];
		$this->customer_age->AdvancedSearch->SearchOperator = @$filter["z_customer_age"];
		$this->customer_age->AdvancedSearch->SearchCondition = @$filter["v_customer_age"];
		$this->customer_age->AdvancedSearch->SearchValue2 = @$filter["y_customer_age"];
		$this->customer_age->AdvancedSearch->SearchOperator2 = @$filter["w_customer_age"];
		$this->customer_age->AdvancedSearch->save();
		...
		// Field lat
		$this->lat->AdvancedSearch->SearchValue = @$filter["x_lat"];
		$this->lat->AdvancedSearch->SearchOperator = @$filter["z_lat"];
		$this->lat->AdvancedSearch->SearchCondition = @$filter["v_lat"];
		$this->lat->AdvancedSearch->SearchValue2 = @$filter["y_lat"];
		$this->lat->AdvancedSearch->SearchOperator2 = @$filter["w_lat"];
		$this->lat->AdvancedSearch->save();

		// Field lon
		$this->lon->AdvancedSearch->SearchValue = @$filter["x_lon"];
		$this->lon->AdvancedSearch->SearchOperator = @$filter["z_lon"];
		$this->lon->AdvancedSearch->SearchCondition = @$filter["v_lon"];
		$this->lon->AdvancedSearch->SearchValue2 = @$filter["y_lon"];
		$this->lon->AdvancedSearch->SearchOperator2 = @$filter["w_lon"];
		$this->lon->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		if (!$Security->canSearch())
			return "";
		$this->buildSearchSql($where, $this->loan_section_id, $default, FALSE); // loan_section_id
		$this->buildSearchSql($where, $this->loan_section_name, $default, FALSE); // loan_section_name
		...
		$this->buildSearchSql($where, $this->loan_purpose_name, $default, FALSE); // loan_purpose_name
		...
		if (!$default && $this->Command == "search") {
			$this->loan_section_id->AdvancedSearch->save(); // loan_section_id
			$this->loan_section_name->AdvancedSearch->save(); // loan_section_name
			$this->user_id->AdvancedSearch->save(); // user_id
			$this->_email->AdvancedSearch->save(); // email
			$this->loan_purpose_id->AdvancedSearch->save(); // loan_purpose_id
			$this->loan_purpose_name->AdvancedSearch->save(); // loan_purpose_name
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->loan_section_name, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->_email, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->loan_purpose_name, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->customer_id, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->status, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->customer_first_name, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->customer_last_name, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->customer_age, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->sex, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->address, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->lat, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->lon, $arKeywords, $type);
		return $where;
	}
	...
	protected function checkSearchParms()
	{
		...
		if ($this->BasicSearch->issetSession())
			return TRUE;
		if ($this->loan_section_id->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->loan_section_name->AdvancedSearch->issetSession())
			return TRUE;
		...
		if ($this->loan_purpose_id->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->loan_purpose_name->AdvancedSearch->issetSession())
			return TRUE;
	...
	{
		$this->loan_section_id->AdvancedSearch->unsetSession();
		$this->loan_section_name->AdvancedSearch->unsetSession();
		$this->user_id->AdvancedSearch->unsetSession();
		$this->_email->AdvancedSearch->unsetSession();
		$this->loan_purpose_id->AdvancedSearch->unsetSession();
		$this->loan_purpose_name->AdvancedSearch->unsetSession();
	...
	protected function restoreSearchParms()
	{
		...
		$this->loan_section_id->AdvancedSearch->load();
		$this->loan_section_name->AdvancedSearch->load();
		$this->user_id->AdvancedSearch->load();
		$this->_email->AdvancedSearch->load();
		$this->loan_purpose_id->AdvancedSearch->load();
		$this->loan_purpose_name->AdvancedSearch->load();
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->loan_section_id); // loan_section_id
			$this->updateSort($this->loan_section_name); // loan_section_name
			$this->updateSort($this->user_id); // user_id
			$this->updateSort($this->_email); // email
			$this->updateSort($this->loan_purpose_id); // loan_purpose_id
			$this->updateSort($this->loan_purpose_name); // loan_purpose_name
			$this->updateSort($this->assessment_id); // assessment_id
			$this->updateSort($this->customer_id); // customer_id
			$this->updateSort($this->total_score); // total_score
	...
	public function renderListOptions()
	{
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->loan_section_id->CurrentValue . Config("COMPOSITE_KEY_SEPARATOR") . $this->user_id->CurrentValue . Config("COMPOSITE_KEY_SEPARATOR") . $this->loan_purpose_id->CurrentValue . Config("COMPOSITE_KEY_SEPARATOR") . $this->assessment_id->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fview1listsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview1listsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fview1list}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function loadSearchValues()
	{
		...
		// loan_section_id
		if (!$this->isAddOrEdit() && $this->loan_section_id->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->loan_section_id->AdvancedSearch->SearchValue != "" || $this->loan_section_id->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// loan_section_name
		if (!$this->isAddOrEdit() && $this->loan_section_name->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->loan_section_name->AdvancedSearch->SearchValue != "" || $this->loan_section_name->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// loan_purpose_name
		if (!$this->isAddOrEdit() && $this->loan_purpose_name->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->loan_purpose_name->AdvancedSearch->SearchValue != "" || $this->loan_purpose_name->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
	...
	public function loadRowValues($rs = NULL)
	{
		...
		if (!$rs || $rs->EOF)
			return;
		$this->loan_section_id->setDbValue($row['loan_section_id']);
		$this->loan_section_name->setDbValue($row['loan_section_name']);
		$this->user_id->setDbValue($row['user_id']);
		$this->_email->setDbValue($row['email']);
		$this->loan_purpose_id->setDbValue($row['loan_purpose_id']);
		$this->loan_purpose_name->setDbValue($row['loan_purpose_name']);
	...
	{
		$row = [];
		$row['loan_section_id'] = NULL;
		$row['loan_section_name'] = NULL;
		$row['user_id'] = NULL;
		$row['email'] = NULL;
		$row['loan_purpose_id'] = NULL;
		$row['loan_purpose_name'] = NULL;
	...
	protected function loadOldRecord()
	{
		...
		$validKey = TRUE;
		if (strval($this->getKey("loan_section_id")) != "")
			$this->loan_section_id->OldValue = $this->getKey("loan_section_id"); // loan_section_id
		else
			$validKey = FALSE;
		...
		if (strval($this->getKey("loan_purpose_id")) != "")
			...
			$validKey = FALSE;
		if (strval($this->getKey("assessment_id")) != "")
			$this->assessment_id->OldValue = $this->getKey("assessment_id"); // assessment_id
		else
			$validKey = FALSE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->loan_section_id->EditValue = HtmlEncode($this->loan_section_id->AdvancedSearch->SearchValue);
			$this->loan_section_id->PlaceHolder = RemoveHtml($this->loan_section_id->caption());
			...
			if (!$this->loan_section_name->Raw)
				$this->loan_section_name->AdvancedSearch->SearchValue = HtmlDecode($this->loan_section_name->AdvancedSearch->SearchValue);
			$this->loan_section_name->EditValue = HtmlEncode($this->loan_section_name->AdvancedSearch->SearchValue);
			...
			if (!$this->loan_purpose_name->Raw)
				$this->loan_purpose_name->AdvancedSearch->SearchValue = HtmlDecode($this->loan_purpose_name->AdvancedSearch->SearchValue);
			$this->loan_purpose_name->EditValue = HtmlEncode($this->loan_purpose_name->AdvancedSearch->SearchValue);
			...
			if (!$this->customer_last_name->Raw)
				$this->customer_last_name->AdvancedSearch->SearchValue = HtmlDecode($this->customer_last_name->AdvancedSearch->SearchValue);
			$this->customer_last_name->EditValue = HtmlEncode($this->customer_last_name->AdvancedSearch->SearchValue);
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fview1list, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fview1list, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fview1list, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_view1" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_view1\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fview1list, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fview1listsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
