 ...
 * Page class
 */
class answers_delete extends answers
{
	...
	// Page object name
	public $PageObjName = "answers_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("answerslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("answerslist.php"); // Return to list
			}
		}
	}
