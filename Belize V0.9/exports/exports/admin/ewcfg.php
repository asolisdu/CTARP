...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "IDB_EcoMicro_BZ"); // Project name
...
$CONFIG = [
	...
	"PROJECT_ID" => "{98C27E89-2937-4D47-9B89-35CA334C4E82}", // Project ID (GUID)
	...
	// Audit trail
	"AUDIT_TRAIL_PATH" => "C:\\Program Files (x86)\\Ampps\\www\\fletex.tk\\bz\\logs\\", // Audit trail path (relative to app root)
