 ...
 * Page class
 */
class results_delete extends results
{
	...
	// Page object name
	public $PageObjName = "results_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("resultslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("resultslist.php"); // Return to list
			}
		}
	}
