...
class index
{
	...
	public function run()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'assessments'))
			$this->terminate("assessmentslist.php"); // Exit and go to default page
		if ($Security->allowList(CurrentProjectID() . 'answers'))
			$this->terminate("answerslist.php");
		if ($Security->allowList(CurrentProjectID() . 'question_types'))
		...
		if ($Security->allowList(CurrentProjectID() . 'loan_purposes'))
			$this->terminate("loan_purposeslist.php");
		if ($Security->allowList(CurrentProjectID() . 'loan_section'))
			$this->terminate("loan_sectionlist.php");
		if ($Security->allowList(CurrentProjectID() . 'question_category'))
			$this->terminate("question_categorylist.php");
		if ($Security->allowList(CurrentProjectID() . 'question_groups'))
