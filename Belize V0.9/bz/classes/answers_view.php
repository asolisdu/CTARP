 ...
 * Page class
 */
class answers_view extends answers
{
	...
	// Page object name
	public $PageObjName = "answers_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "answerslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "answerslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "answerslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
