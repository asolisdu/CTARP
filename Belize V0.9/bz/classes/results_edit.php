 ...
 * Page class
 */
class results_edit extends results
{
	...
	// Page object name
	public $PageObjName = "results_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// answers
			$this->answers->setDbValueDef($rsnew, $this->answers->CurrentValue, NULL, $this->answers->ReadOnly);
