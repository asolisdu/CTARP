 ...
 * Page class
 */
class questions_view extends questions
{
	...
	// Page object name
	public $PageObjName = "questions_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "questionslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "questionslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "questionslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
