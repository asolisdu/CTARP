 ...
 * Page class
 */
class results_grid extends results
{
	...
	// Page object name
	public $PageObjName = "results_grid";

	// Grid form hidden field names
	public $FormName = "fresultsgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function loadDefaultValues()
	{
		...
		$this->answers->CurrentValue = NULL;
		$this->answers->OldValue = $this->answers->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row['answers'] = $this->answers->CurrentValue;
		return $row;
	}
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// assessment_id
			$this->assessment_id->setDbValueDef($rsnew, $this->assessment_id->CurrentValue, NULL, $this->assessment_id->ReadOnly);
			...
			$keyValue = isset($rsnew['assessment_id']) ? $rsnew['assessment_id'] : $rsold['assessment_id'];
			if (strval($keyValue) != "") {
			...
			if (!$validMasterRecord) {
				$relatedRecordMsg = str_replace("%t", "assessments", $Language->phrase("RelatedRecordRequired"));
	...
	protected function addRow($rsold = NULL)
	{
		...
		// assessment_id
		$this->assessment_id->setDbValueDef($rsnew, $this->assessment_id->CurrentValue, NULL, FALSE);
